...
g++ -c -Wall -std=c++11 testy.cpp -o testy.o
g++ Point.o generateRandom.o Factors.o TimeRange.o TimeRangeM.o Action.o Sleep.o Coffee.o CoffeeAndSleepGoalFunction.o goalFunction.o addAction.o DayActionsM.o Chromosome.o GeneticAlgorithm.o testy.o -o testy.exe
testy.exe
